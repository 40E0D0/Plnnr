...
import AvatarWidget from "../components/Avatar";  // Import Avatar component
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        setUserData(profile);
        setFormData(profile);
        setAvatarUrl(profile.avatar_url); // Set the avatar URL if available in profile
      } catch (err) {
  ...
  const handleSaveClick = async () => {
    ...
    const { error } = await supabase
      ...
      .update({
        ...
        level_study: formData.level_study,
